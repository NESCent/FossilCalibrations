...
-->
	...
	<div id="site-news">
		<h3 class="contentheading" style="margin-top: 0; line-height: 1.25em;">Best Practices for Citing Fossil Calibrations
		</h3>
		...
		<h3 class="contentheading" style="margin-top: 0; line-height: 1.25em;">Best Practices for Justifying Fossil Calibrations
			<br/>
			<a style="color: #999 !important; line-height: 0.8em; font-style: italic; font-size: 0.8em;" href="#">(Parham, 2012)</a>
		</h3>
		<ol class="best-practices">
			<li><a href="#">Museum numbers of specimen(s) that
				demonstrate all the relevant characters and provenance data should be
				listed. Referrals of additional specimens to the focal taxon should be
				justified.</a></li>
			<li><a href="#">An apomorphy-based diagnosis of the specimen(s) or an explicit,
				up-to-date, phylogenetic analysis that includes the specimen(s) should be
				referenced.</a></li>
			<li><a href="#">Explicit statements on the
				reconciliation of morphological and molecular data sets should be
				given</a></li>
			<li><a href="#">The locality and stratigraphic level
				(to the best of current knowledge) from which the calibrating fossil(s)
				was/were collected should be specified.</a></li>
			<li><a href="#">Reference to a published radioisotopic
				age and/or numeric timescale and details of
				numeric age selection should be given.</a></li>
		</div>
