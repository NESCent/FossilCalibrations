<?php 
/*
 * This is a faceless script that tries to delete a locality record, then
 * redirect to the main localities list.
 * 
...
$query="DELETE FROM localities
	WHERE LocalityID = '". mysql_real_escape_string($fossilID) ."'";
$result=mysql_query($query) or die ('Error  in query: '.$query.'|'. mysql_error());

// TODO: delete any related/dependent records?

// bounce back to the edit page? or a simple result page
header('Location: https://'. $_SERVER['HTTP_HOST'] .'/protected/manage_localities.php');
exit();
?>
